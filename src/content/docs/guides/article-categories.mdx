...
3. If posting on a platform with limited characters, or unable to use links then put
   ...
   Then take the first paragraph of the article after the introdcution and use it as your post.

4. If you can use links and include more paragrahps from the article then place the link to the article at the start and end of your post and post the first 3 paragraphs of the article.
